...
export const ui = {
  en: {
    ...
    common: {
      ...
      emailPi: 'Email Prof. Yerin Hwang',
      mainNav: 'Main',
    ...
    join: {
      ...
      emailTitle: 'What to include in your first email',
      checklist: [
        'a short introduction',
        'the opportunity you are asking about',
        'research interests and why they connect to LUMI',
        'CV',
        'expected start date and period',
        'links to relevant papers, projects, GitHub repositories, or code samples, when available',
      ],
      transcriptNote: 'A transcript is optional for the first inquiry unless otherwise specified.',
  ...
  ko: {
    ...
    home: {
      metaDescription:
        'LUMI Lab(Language Understanding and Machine Intelligence)은 동국대학교 컴퓨터AI학부 연구실입니다. 신뢰할 수 있는 언어·멀티모달 모델, LLM 에이전트, 평가, 지시 수행, 피드백을 연구합니다.',
      heroLead:
        '동국대학교 컴퓨터AI학부 황예린 교수 연구실입니다. 자연어처리와 대규모 언어모델, 그리고 신뢰할 수 있는 AI를 연구합니다. LLM 평가, 안정적인 에이전트, 멀티모달 시스템, AI 안전성이 주요 주제입니다.',
      exploreResearch: '연구 살펴보기',
      joinLumi: '지원 안내',
      heroRecruiting:
        '연구실을 함께 만들어 갈 대학원생, 학부 연구인턴, 공동 연구자의 연락을 기다립니다.',
      missionTitle: '가장 중요한 곳에서의 신뢰성을 연구합니다',
      missionBody:
        'LUMI(Language Understanding and Machine Intelligence)는 동국대학교 컴퓨터AI학부 소속 연구실로, 황예린 교수가 이끌고 있습니다. 자연어처리, 신뢰할 수 있는 AI, 에이전트 시스템, 멀티모달 평가가 만나는 지점을 연구합니다. 최신 AI 시스템이 현실적인 조건에서 어디서부터 무너지는지 규명하고, 그 동작을 더 믿을 수 있게 만드는 벤치마크와 분석, 방법론을 만듭니다.',
      projectsEyebrow: '진행 중인 연구',
      projectsTitle: '지금 붙잡고 있는 질문들',
      projectsIntro:
        '현재 연구들은 AI 시스템이 한 번 답을 내놓는 데 그치지 않고 평가하고, 선택하고, 우선순위를 정하고, 고쳐야 할 때 드러나는 실패를 다룹니다.',
      exploreAllResearch: '연구 전체 보기',
      areasEyebrow: '연구 분야',
      areasTitle: '평가에서 신뢰할 수 있는 행동까지',
      areasIntro:
        '모델이 무엇을 아는지만이 아니라, 어떻게 판단하고 무엇을 우선하며 도구와 어떻게 상호작용하는지, 그리고 첫 시도가 틀렸을 때 어떻게 반응하는지를 통해 지능을 살펴봅니다.',
      pubsEyebrow: 'Publications',
      pubsTitle: '지도교수 주요 논문',
      pubsIntro: 'LUMI에서 이어가고 있는 질문의 배경이 된 연구들입니다.',
    ...
    cta: {
      eyebrow: '연구실 지원',
      title: '새 연구 그룹을 함께 만들어 갑니다.',
      body: '정교한 실험과 탄탄한 평가로, 벤치마크 점수 너머의 질문을 파고들 학생과 공동 연구자를 환영합니다.',
      primary: '지원 안내 보기',
      secondary: '연락하기',
    },
    research: {
      metaDescription:
        'LUMI Lab은 언어·멀티모달 AI의 신뢰성을 연구합니다. 신뢰할 수 있는 평가, 안정적인 에이전트, 피드백과 수정, 데이터 중심 연구와 한국어 NLP를 다룹니다.',
      kicker: '무엇을 연구하는가',
      title: '충돌과 불확실성, 그리고 피드백 속에서의 신뢰할 수 있는 AI',
      intro:
        '강력한 모델도 깔끔한 단일 질의 환경에서는 안정적으로 보이지만, 목표가 서로 충돌하거나 평가 신호가 편향되거나 도구마다 비용이 다르거나 앞선 출력을 고쳐야 할 때 무너집니다. 저희는 이런 압력 지점을 측정 가능한 질문으로 바꾸고, 통제된 실험으로 겉으로 드러나는 행동과 그 이면의 메커니즘을 함께 규명합니다.',
      areasEyebrow: '연구 분야',
      areasTitle: '네 가지 방향',
      areasIntro:
        '각 분야는 평균적으로는 멀쩡해 보이는 능력이 더 까다로운 조건에서 어디서부터 무너지는지를 묻습니다.',
      ...
      methodologyBody:
        '벤치마크 설계, 행동 기반 평가, 사람과 모델을 함께 활용한 분석, 통제된 개입, 그리고 메커니즘 분석 도구를 함께 씁니다. 모든 프로젝트에서 흔히 뭉뚱그려지는 능력을 분리해 보려 합니다. 예를 들어 오류를 알아보는 것과 실제로 고치는 것, 지시의 우선순위를 내부적으로 표현하는 것과 그에 따라 행동하는 것, 과제를 이해하는 것과 표면적인 표현이 비슷할 뿐인 것을 구분하는 일입니다.',
      collabEyebrow: '공동 연구',
      collabTitle: '함께 연구하기',
      collabIntro:
        '평가, 에이전트 안정성, AI 안전성에 관한 학계·산업계와의 공동 연구를 환영합니다. 이 질문들을 함께 붙잡고 싶은 학생의 연락도 기다립니다.',
      researchOpportunities: '지원 안내 보기',
    },
    people: {
      metaDescription:
        '황예린 교수는 동국대학교 컴퓨터AI학부에서 LUMI Lab을 이끌며 신뢰할 수 있는 언어모델, LLM 평가, 안정적인 에이전트, 멀티모달 시스템을 연구합니다.',
      researchInterests: '연구 관심 분야',
      links: '링크',
      cv: 'CV (PDF)',
      labMembers: '연구실 구성원',
      publicationsHeading: 'Publications',
      publicationsNote: 'LUMI Lab 설립 이후의 연구는 별도로 LUMI Lab 연구로 표시됩니다.',
      growingTitle: '함께할 분을 찾고 있습니다',
      growingBody:
        '연구실이 성장하면서 새로운 구성원이 이곳에 추가될 예정입니다. 신뢰할 수 있는 AI와 꼼꼼한 실증 연구에 관심 있는 대학원 진학 희망자와 학부 연구인턴의 문의를 환영합니다.',
      joinLumi: '지원 안내 보기',
    ...
    publications: {
      ...
      title: '주요 논문 및 이전 연구',
      intro:
        '현재 이 페이지에는 지도교수의 주요 논문이 정리되어 있습니다. LUMI Lab 설립 이후의 연구는 별도로 LUMI Lab 연구로 표시됩니다.',
      jumpToYear: '연도로 이동',
    ...
    join: {
      metaDescription:
        'LUMI Lab은 신뢰할 수 있는 언어모델, 안정적인 에이전트, 멀티모달 평가, AI 안전성에 관심 있는 대학원생, 학부 연구인턴, 공동 연구자를 환영합니다.',
      kicker: '연구실 지원',
      title: '정확하고, 쓸모 있고, 신뢰할 수 있는 AI 연구를 함께',
      intro:
        '신뢰할 수 있는 언어모델, 안정적인 에이전트, 멀티모달 평가, AI 안전성에 관심 있는 대학원 진학 희망자, 학부 연구인턴, 공동 연구자의 문의를 환영합니다. 호기심과 주도성, 꼼꼼한 실험, 명확한 소통, 그리고 동료에 대한 존중을 중요하게 생각합니다.',
      opportunitiesEyebrow: '모집 분야',
      opportunitiesTitle: '이런 분을 찾고 있습니다',
      opportunities: [
        {
          title: '대학원생',
          text: '신뢰할 수 있는 LLM, 에이전트 안정성, 평가, 멀티모달 시스템을 연구하고 싶은 대학원 진학 희망자는 관심 분야와 지금까지의 경험을 소개해 주세요.',
        },
        {
          title: '학부 연구인턴',
          text: '학부생도 연구 인턴을 문의할 수 있습니다. 연구 경험이 있으면 도움이 되지만 필수는 아닙니다. 스스로 움직인 경험, 탄탄한 프로그래밍 기초, 논문을 꼼꼼히 읽고 직접 확인해 보려는 태도를 특히 눈여겨봅니다.',
        },
        {
          title: '공동 연구 및 과제',
      ...
      checklist: [
        ...
        'CV',
        '가능한 시작 시기와 기간',
        '관련 논문·프로젝트·GitHub 저장소·코드 링크 (있는 경우)',
      ],
      transcriptNote: '첫 문의에는 성적증명서를 꼭 첨부하지 않으셔도 됩니다.',
      subjectLabel: '메일 제목 예시',
